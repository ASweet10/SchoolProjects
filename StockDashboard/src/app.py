...
#
    ...
    if time_value == '5D':
        ...
        time_unix = now - relativedelta(months=1)
    elif time_value == '3mo':
        time_unix = now - relativedelta(months=3)
    elif time_value == '6mo':
        time_unix = now - relativedelta(months=6)
    elif time_value == 'ytd':
        nowDate = now.date()
        ...
        time_unix = now - relativedelta(days=days_since_new_year.days)
    elif time_value == '1y':
        time_unix = now - relativedelta(years=1)
    else:
    ...
    time_unix = int(time_unix.timestamp())
    data = finnhub_client.stock_candles(ticker, 'D', time_unix, now_unix)
